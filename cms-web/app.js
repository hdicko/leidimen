...
function getFormData() {
    const villages = Array.from(document.getElementById('postVillage').selectedOptions)
        .map(opt => opt.value);
...
async function loadPosts() {
    ...
    postsList.innerHTML = '<div class="text-center"><div class="spinner-border" role="status"><span class="visually-hidden">Chargement...</span></div></div>';
