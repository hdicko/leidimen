...
export function registerTools(server, hugoRoot) {
  ...
  server.tool(
    ...
    "Create a new Hugo blog post with proper frontmatter for Leidimen",
    {
      ...
      date: z
        .string()
        .optional()
        .describe("Publication date (YYYY-MM-DD). Defaults to today."),
      villages: z
        .array(
          z.enum([
            "douentza",
      ...
      categories: z
        .array(z.string())
        .optional()
        .describe("Categories (e.g., Éducation, Santé, Infrastructure)"),
      tags: z.array(z.string()).optional().describe("Tags/keywords"),
      moods: z
        .array(
          z.enum(["heureux", "triste", "inspire", "motive", "reconnaissant"])
        )
        .optional()
      ...
      description: z
        .string()
        .optional()
        .describe("SEO description (150-160 chars recommended)"),
      ...
      draft: z
        ...
        .optional()
        .default(false)
        .describe("Whether this is a draft"),
      isBundle: z
        .boolean()
        .optional()
        .default(false)
        .describe(
          "Create as page bundle (folder with index.md) for galleries"
        ),
    },
  ...
  server.tool(
    ...
    "Build the Leidimen Hugo site (production or draft mode)",
    {
      includeDrafts: z
        ...
        .optional()
        .default(false)
        .describe("Include draft content in the build"),
      minify: z
        .boolean()
        .optional()
        .default(true)
        .describe("Minify output (HTML, CSS)"),
    },
  ...
  server.tool(
    ...
    "List Hugo content items (posts, team members, galleries, villages)",
    {
      ...
      year: z
        .string()
        .optional()
        .describe("Filter posts by year (e.g., '2025')"),
      village: z
        .string()
        .optional()
        .describe("Filter posts by village"),
  ...
  server.tool(
    ...
    "Create a new team member profile for the Leidimen équipe",
    {
      ...
      fonction: z
        .string()
        .describe("Role/function (e.g., Président, Trésorier)"),
      membre: z
        .enum(["fondateur", "bureau", "adherent", "bienfaiteur"])
      ...
      body: z
        .string()
        .optional()
        .describe("Full biography in Markdown"),
    },
  ...
  server.tool(
    ...
    "Validate Hugo content files for common issues (taxonomy casing, missing fields, image paths)",
    {
      path: z
        ...
        .optional()
        .describe(
          "Specific file or folder to validate (relative to content/). Defaults to all content."
        ),
    },
  ...
  server.tool(
    ...
    "Full-text search across all Hugo content files",
    {
      ...
      contentType: z
        .enum(["all", "posts", "equipe", "galleries", "villages"])
        .optional()
        .default("all"),
    },
  ...
  server.tool(
    ...
    "Read and parse a Hugo content file, returning frontmatter and body separately",
    {
      path: z
        .string()
        .describe(
          "Relative path from content/ (e.g., 'posts/2025/my-post.md')"
        ),
    },
  ...
  server.tool(
    ...
    "Update frontmatter fields of an existing Hugo content file",
    {
      ...
      fields: z
        ...
        .describe("Key-value pairs to update in frontmatter"),
    },
