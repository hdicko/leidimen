...
7. **Specialized Domain Tasks**:
   - Pattern: Hugo/framework-specific, accessibility (WCAG), testing (TDD), API design
   - Characteristics: Deep domain knowledge, framework conventions, standards compliance
   - Keywords: hugo, accessibility, wcag, rest, api, testing, tdd
