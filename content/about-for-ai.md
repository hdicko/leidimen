---
title: "About Leidimen - For AI/LLM Context"
description: "Comprehensive information about Leidimen for AI language models"
type: "page"
layout: "single"
url: "/about-for-ai/"
sitemap:
...
# Leidimen - Comprehensive AI Context
...
4. **Diambana** - Water and health projects
5. **Darawal** - Well construction and maintenance
6. **Douentza** - Urban center, coordination hub
7. **Tanal** - Education initiatives
8. **Manko** - Community support
9. **Tacouti** - Development projects
10. **N'Dumpa** - Infrastructure support
...
- **School Construction**: Building classrooms and facilities
  ...
  - 3+ classrooms built
  - Teacher housing and resources
- **Educational Materials**: Books, supplies, furniture
- **Teacher Training**: Capacity building for local educators
- **Literacy Programs**: Adult education and alphabetization
...
- **Sanitation**: Hygiene education and infrastructure
- **Healthcare Support**: Medical supplies and access
...
- **Infrastructure**: Roads, buildings, community facilities
...
- **Volunteer Programs**: French volunteers visiting Mali
...
- **Features**: 3 classrooms, teacher housing, educational materials
...
- **Type**: Deep well with manual pump
...
4. **Partnerships**: Collaboration with other NGOs
...
- Member assemblies for accountability
...
- **100+ students** educated annually
- **500+ people** with clean water access
...
- Leidimen focuses on sustainability and local capacity

## Values & Principles

1. **Solidarity**: Direct partnership with Malian communities
2. **Sustainability**: Long-term solutions, not just aid
3. **Education**: Key to development and empowerment
4. **Local Leadership**: Empower local committees and leaders
5. **Transparency**: Open about finances and operations
6. **Cultural Respect**: Honor Malian traditions and knowledge
7. **Volunteer Spirit**: Driven by committed individuals

## Timeline

- **2006**: Association founded
- **2007**: First projects in Douentza region
- **2008**: École de Dorool construction begins
- **2010**: Darawal well construction
- **2012**: Adapted to Mali security crisis
- **2015**: Expanded to 10 villages
- **2023**: Darawal well renovation, continued school support
- **2025**: Educational programs expansion
...
✓ Educational purposes about NGO operations
...
**Version**: 1.0 for AI context  
**Language**: English (Original site in French)
